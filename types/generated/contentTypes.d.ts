...
export interface ApiClickNumberClickNumber extends Struct.CollectionTypeSchema {
  collectionName: 'click_numbers';
  info: {
    displayName: 'Click_Number';
    pluralName: 'click-numbers';
    singularName: 'click-number';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Comment: Schema.Attribute.Enumeration<
      [
        'Facebook',
        'Instagram',
        'Twitter/X',
